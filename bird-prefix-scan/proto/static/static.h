...
struct static_proto {
  ...
  int bench_reported;			/* Benchmark line already emitted */
  btime bench_start_us;		/* Wall-clock start for benchmark protocol */
  u32 bench_route_count;		/* Number of routes announced by benchmark */
...
struct static_route {
  ...
  net_addr *aspa_prefix;		/* Optional ASPA prefix selector */
  adata *aspa_providers;		/* ASPA provider list as configured */
  adata *aspa_data;			/* Serialized ASPA payload for EA_ASPA_PROVIDERS */
